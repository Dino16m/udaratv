...
<div class="float-button d-block "> <a class="w-100 h-100 mx-auto my-auto d-block" href="#/request"><img class="rounded-circle h-100 w-100" src="{{url('public/css/udara.jpg')}}"></a> </div>
<!--ad network-->
        <?php echo include_once (base_path('resources/views/pa_antiadblock_2523831.php')); ?>
    <!--end of ad-->
<section>
