...
<head>
    ...
    <meta name="og:description" property="og:description" content="download {{$name}} season {{$season}} episode {{$episode}}">
...
<div id="app">
    ...
    <request api="{{url('api/subscribe')}}" v-bind:isroute=false v-bind:isfinal=true></request>
    <router-view api="{{url('api/subscribe')}}" v-bind:isroute=true v-bind:isfinal=true> </router-view>
            ...
            <div class="row">
                ...
                <div class="col-md-3 mx-auto">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li>
                            <a href="{{url('types/hollywoodmovies')}}">Hollywood Tvseries</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="{{url('types/animeseries')}}">Anime Tvseries</a>
                        </li>
                        <li>
